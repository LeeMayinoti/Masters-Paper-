...
A central limitation of this work is that cultural authenticity has so far been judged only by LLMs and a keyword scanner. No \juhoansi{} community members, elders, or cultural experts participated in evaluating the generated stories. For a system whose stated purpose is indigenous cultural preservation, this gap means the pilot results demonstrate computational consistency rather than cultural validity. The participatory evaluation planned with the Donkerbos \juhoansi{} community remains essential before any claims about cultural authenticity can be substantiated.
