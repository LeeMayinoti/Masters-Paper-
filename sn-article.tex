...
\begin{enumerate}
\item \textbf{Generator Agent}: Receives Neo4j subgraphs, RAG folktale excerpts, and vocabulary constraints from \texttt{ju\_dictionary.xls}. It generates narratives guided by Camp/Bush spatial dynamics and Dundes motifemes (Appendix~\ref{app:sample}).
...
\midrule
\textbf{All 8 themes} & \textbf{2.15} & \textbf{6.36} & \textbf{+4.21} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Community evaluation gap.} A central limitation of this work is that cultural authenticity has so far been judged only by LLMs and a keyword scanner. No \juhoansi{} community members, elders, or cultural experts participated in evaluating the generated stories. For a system whose stated purpose is indigenous cultural preservation, this gap means the pilot results demonstrate computational consistency rather than cultural validity. The participatory evaluation planned with the Donkerbos \juhoansi{} community remains essential before any claims about cultural authenticity can be substantiated.
...
Future work will expand the knowledge graph to the remaining corpus stories, conduct participatory evaluation with \juhoansi{} speakers and cultural experts, audit the Generator Agent's hardcoded vocabulary against the reference lexicon, and explore the framework's applicability to other indigenous oral traditions.
...
\section{Sample Generated Narrative and Classifier Output}\label{app:sample}

The narrative below is the unedited \texttt{jnang} output for the trickster and waterhole
theme, one of the 8 themes in the evaluation reported in Section~\ref{sec:results}. It is
followed by the Classifier Agent's structural analysis of that text and the two graders' scores,
so that output quality can be judged directly rather than through a summary score.

\subsection*{Generated narrative}

In the vast and shimmering Kalahari, where the red sand dunes dance under the sun's gaze, there lived a clever springhare named Tjua. Tjua was known for his quick legs and even quicker mind, but he was also known to be a trickster. One day, while hopping through the bush, Tjua stumbled upon a hidden waterhole, its waters sparkling like stars at night.

Lack (of water) soon became the theme of Tjua's thoughts, for the community was suffering from thirst. The elders, including his wise grandmother, !ga, gathered around the campfire each evening, sharing stories of the past and worrying about the dwindling water supplies. But Tjua, instead of sharing this precious secret with the thirsty community, decided to keep it all for himself.

Interdiction came when the spirits of the bush whispered to Tjua, warning him that hoarding water would bring dire consequences. ``Tjua, do not hide this waterhole,'' they said in voices like rustling leaves. But Tjua, thinking of himself, ignored the spirits' words and continued to visit the waterhole in secret, drinking deeply while the others parched under the sun.

As days passed, the community grew weaker. The children, led by Tjua's age-mate, !xo, began to search tirelessly for water. They asked Tjua, ``Have you seen any water, dear friend?'' Tjua merely smiled, hiding the truth behind his twitching whiskers. This violation of trust would not go unnoticed.

The consequence came one evening when the sun dipped low, painting the sky with hues of orange and purple. Tjua, feeling bold, decided to drink from the waterhole one last time before sharing the secret. As he approached, he noticed the ground trembling slightly. This was no ordinary waterhole; it was a sacred place, and the spirits were angered by his selfishness.

Just as he leaned down to drink, the water began to swirl and shimmer, transforming into a great g//awasi spirit, glowing and formidable. ``Tjua, you have kept the life of the community from them! You must return what you have stolen!'' the spirit bellowed, its voice echoing across the dunes.

Mediation came when Tjua, trembling with fear, realized the depth of his violation. He remembered the laughter of the children, the tired faces of the elders, and the parched earth that surrounded him. With a heavy heart, he agreed to share the secret waterhole. He dashed back through the bush, calling out to the community, ``Come! I have found water!''

Upon reaching the camp, Tjua found everyone gathered, their eyes wide with hope. He led them to the hidden waterhole, where the water sparkled again under the moonlight. The community rejoiced, filling their buckets, and as they drank, they laughed and danced, sharing the life-giving water.

Through this act of restoration, Tjua learned the value of community over individual gain. The spirits of the bush smiled upon them, and from that day forward, Tjua became known not just as a trickster, but as a provider who had learned to share. And so, the community flourished, united by the precious water and the bonds of kinship that tied them together.

From that day, every time they gathered around the campfire, they would tell the story of Tjua and the hidden waterhole, a reminder that sharing brings life and joy to all.

\subsection*{Classifier Agent output}

\noindent \textbf{Motifemes identified}: Lack, Interdiction, Violation, Consequence, Mediation, Lack Liquidated.

\medskip

\noindent \textbf{Narrative moves}:
\begin{enumerate}
    \item Tjua discovers hidden waterhole
    \item Elders express concern over water shortage
    \item Spirits warn Tjua against hoarding water
    \item Tjua ignores spirits and drinks from waterhole
    \item Community searches for water
    \item G//awasi spirit confronts Tjua for his selfishness
    \item Tjua agrees to share the waterhole with the community
    \item Community rejoices as they drink from the waterhole
\end{enumerate}

\subsection*{Grader scores for this narrative}

\noindent In-pipeline Grader: cultural authenticity 6.67,
motifeme coverage 10.0, overall \textit{Fails}.
Independent judge: cultural authenticity 8.0,
motifeme coverage 10.0, overall \textit{Good}.
